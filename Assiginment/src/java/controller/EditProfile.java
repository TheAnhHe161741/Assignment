...
public class EditProfile extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        dao.editProfile(email, pass, name, gender, phone, dob, address, id);
        // Hien thi script thong bao edit product thanh cong --> day nguoi ve trang productList
        response.getWriter().print("<script> alert(\"Profile edited successfully!\"); window.location = \"home\";</script>");
    }
