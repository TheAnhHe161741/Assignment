...
<html>
    <head>
        ...
        <title>TheAnh productlist1 Supermarket</title>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <c:if test="${user.getIsAdmin() == 1}">
                                <span><a href="addToProduct" class="btn btn-primary">Add New Product</a></span>
                            </c:if>
                            <c:if test="${user.getIsAdmin() != 1}">
                                <span><a href="viewCart" class="btn btn-primary">View Cart</a></span>        
                            </c:if>   
                            <br><br>
                        </div>
                    </div>       
